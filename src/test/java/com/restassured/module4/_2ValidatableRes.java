        ...
        public void complexHamcrestMatchers() {
                RestAssured.get(BASE_URL)
                                ...
                                .header("x-ratelimit-limit",
                                                response -> Matchers
                                                                .greaterThan(response.header("x-ratelimit-remaining")));
        }

        Map<String, String> ecpectedHeaders = Map.of("content-encoding", "gzip",
        ...
        public void usingMapsToTestHeaders() {
                RestAssured.get(BASE_URL)
                                ...
                                .headers("content-encoding", "gzip",
                                                "access-control-allow-origin", "*",
                                                "cache-control", Matchers.stringContainsInOrder("public"))

                                // or
                                .headers(ecpectedHeaders);
        }
}
